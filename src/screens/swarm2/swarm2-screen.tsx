...
type RuntimeEntry = {
  ...
  // Set by swarm-dispatch / swarm-orchestrator-loop with the real
  // checkpoint output (vs. the heuristic-extracted lastSummary/lastResult).
  // Reports-view + screen prefer these when present.
